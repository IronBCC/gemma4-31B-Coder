...
def main() -> int:
    ...
    from phaseD_sft.train_rust_lora import label_tokens_for_spans, rendered_assistant_turn_spans
    ...
    for completed, idx in enumerate(indices, start=1):
        messages = ds[int(idx)]["messages"]
